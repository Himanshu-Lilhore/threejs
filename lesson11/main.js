...
// const material = new THREE.MeshPhysicalMaterial();  // same as standard material, but shows a clear shiny coating on top of it (heavier on gpu)
material.metalness = 0.6;
material.roughness = 0.2;
// material.map = doorColorTx;
// material.aoMap = doorAmbientOccTx;
// material.aoMapIntensity = 1;
// material.displacementMap = doorHeightTx; // for this to work, we need more subdivions
// material.displacementScale = 0.05;
// material.metalnessMap = doorMetalnessTx;
// material.roughnessMap = doorRoughnessTx;
// material.normalMap = doorNormalTx;
// material.normalScale.set(0.9, 1);
